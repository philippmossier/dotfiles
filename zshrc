...
# Load ssh generator hook for ubuntu wsl (has no effect on MAC)
...
# # ----------------------------- load local binaries and set path begininning --------------------
# [ -d $HOME/.local/bin ] && PATH="$HOME/.local/bin:$PATH"
...
# # less colorfull colors for exa (optional)
...
#     # Setup fzf inclusive autocompletion and keybindings. Comes from installing fzf via git repo (https://github.com/junegunn/fzf#key-bindings-for-command-line)
...
# # # ============================================ default bash config (after fresh ubuntu22):
